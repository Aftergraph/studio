# Expo reference layer — Living Interface v4
...
V4 maps the shared motion semantics to native-friendly patterns: Reanimated-style springs, haptics, safe-area-aware sheets, Expo Router navigation and SF Symbols through `expo-image`. Today/Library route sources remain supporting/contextual routes, not permanent primary navigation.
