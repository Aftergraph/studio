...
def run_all():
    with sync_playwright() as p:
        ...
        check(mobile.locator('[data-mobile-primary-nav="true"] button').count()==2,'mobile primary nav remains Chat Work only')
        check(mobile.locator('[data-shell-destination="space"]').count()==1,'Space remains reachable through canonical mobile navigation')
