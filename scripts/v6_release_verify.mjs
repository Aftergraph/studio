...
const GATES = [
  ...
  { name: 'V9.0 Lessons Server Exit Gate', cmd: 'node', args: ['--test', 'tests/v90-lessons-server.test.mjs'] },
  ...
  { name: 'User Invite Exit Gate', cmd: 'node', args: ['--test', 'tests/user-invite.test.mjs'] },
