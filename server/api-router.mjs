...
export function sendApiError(res,error){
  ...
  const known=['invalid_json','payload_too_large','forbidden','idempotency_conflict','confirmation_required','actor_required','invalid_decision','invalid_control_mode','approval_not_found','mission_not_found','memory_not_found','authentication_required','unknown_actor','workspace_not_initialized'];
